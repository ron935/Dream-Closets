...
class SMTPMailer {
    ...
    public function send($from, $fromName, $to, $subject, $htmlBody, $textBody = '', $replyTo = '', $replyToName = '', $attachments = []) {
        try {
            ...
            $headers = $this->buildHeaders($from, $fromName, $to, $subject, $boundary, $replyTo, $replyToName, !empty($attachments));
            $body = $this->buildBody($htmlBody, $textBody, $boundary, $attachments);
    ...
    private function buildHeaders($from, $fromName, $to, $subject, $boundary, $replyTo, $replyToName, $hasAttachments = false) {
        $headers = [];
        $headers[] = "Date: " . date('r');
    ...
    private function buildBody($htmlBody, $textBody, $boundary, $attachments = []) {
        $body = [];
